...
// Mock the services
jest.mock('@discovery/modules/discovery.service');
jest.mock('@discovery/search/video-search.service', () => ({
...
import { SearchVideosDto } from '@discovery/modules/dto/search-videos.dto';
import { SearchResponseDto } from '@discovery/modules/dto/search-response.dto';
